...
namespace Stack_Exchange_Statistics_Explorer.Models
{
    ...
    {
        public bool UseRelativeTimes { get; set; } = false;
        ...
        [NotMapped]
        public static string[] ValidDateFormats => new string[] { "MMM d, yyyy", "yyyy-MM-dd", "d\\/M\\/yyyy", "M\\/d\\/yyyy" };

        public int TimeFormat { get; set; } = 0;

        [NotMapped]
        public static string[] ValidTimeFormats => new string[] { "h:mm tt", "HH:mm", "H:mm" };
