<%@ Page Title="All Sites" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Stack_Exchange_Statistics_Explorer.Sites.Default" %>
            ...
            <div runat="server" class="large-3 medium-4 site columns">
                <div onclick="window.location.href = '/Sites/Detail?SiteId=<%#Binder.Eval<Site>(Container, "Site").Id %>'" class="radius panel">
                    ...
                    <p>
                        ...
                        API Site Parameter: <span class="apiParameter"><%#Binder.Eval<Site>(Container, "Site").ApiSiteParameter %></span><br />
